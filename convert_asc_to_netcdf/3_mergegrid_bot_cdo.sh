...
cdo -L -f nc4 -setattribute,description="Transient groundwater heads - Bottom" \
              -setattribute,references="Verkaik et al. (2022) - Geosci. Model Dev. Discuss." \
              -setattribute,source=${INP_FOLDER} \
              -setname,"groundwater_heads_bot" -setunit,1 -setgrid,griddes_global_30arcsec.txt -setmisstoc,0.0 -mergetime \
              '/scratch/6574882/GENEWS/GENEWS/input/1_water_abstraction/globgm_transient_gw_heads_bot/*.nc' transient_Gw_bot_30arcsec_monthly_1958-2015.nc  
...
ncatted -O -a standard_name,"groundwater_heads_bot",m,c,"groundwater_heads_bot" transient_Gw_bot_30arcsec_monthly_1958-2015.nc 
ncatted -O -a     long_name,"groundwater_heads_bot",m,c,"groundwater_heads_bot" transient_Gw_bot_30arcsec_monthly_1958-2015.nc 
